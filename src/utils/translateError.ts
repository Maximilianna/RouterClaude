...
const ERROR_MAP: Record<string, string> = {
  ...
  CLI_PROVIDER_NOT_FOUND: "error.cli_provider_not_found",
  ...
  BASE_URL_REQUIRED: "validation.base_url_required",
  BASE_URL_INVALID: "validation.base_url_invalid",
  AUTH_TOKEN_REQUIRED: "validation.api_key_required",
